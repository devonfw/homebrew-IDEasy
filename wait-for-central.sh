...
# Expected checksums in the same order as PLATFORMS. The flag is kept separately because bash 3.2
# treats the length of an empty array as unbound under 'set -u'.
EXPECTED=()
verify_checksums=0
if [[ "$#" -eq 5 ]]
then
